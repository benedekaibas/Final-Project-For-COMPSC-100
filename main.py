...
class Pictures:
    ...
    def button_save(self):
        ...
        #BUTTON TWO IS NOT INCLUDED IN THE RESULT BECAUSE YOU HAVE TO SWITCH PLAYER TO MOVE ON IN THE GAME, SO IT WOULD BE USELESS TO INCLUDE IT TOO. 
        #NO ONE WOULD GET AN A, IF I WOULD INCLUDE BUTTON TWO AS WELL. 
        if result <= 4:
            print(f"Congratulation your score is: {result}. You are a tennis a tennis enthusiast, good job. You got a perfect A+")
        elif 4 <= result <= 6:
